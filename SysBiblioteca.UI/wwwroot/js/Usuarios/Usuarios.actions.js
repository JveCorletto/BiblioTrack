$('#btnSave').click(function () {
    if ($('#Nombres').val().trim() != "" && $('#Apellidos').val().trim() != "" && $('#Genero').val() > 0 && $('#DUI').val().trim() != ""
        ...
        if (validarFecha($('#FechaNacimiento').val().trim())) {
            ...
            $.ajax({
                type: 'POST',
                url: api + 'Seguridad/CreateUsuario',
...
$('#btnEdit').click(function () {
    if ($('#Nombres').val().trim() != "" && $('#Apellidos').val().trim() != "" && $('#Genero').val() > 0 && $('#DUI').val().trim() != ""
        ...
        if (validarFecha($('#FechaNacimiento').val().trim())) {
            ...
            $.ajax({
                type: 'POST',
                url: api + 'Seguridad/UpdateUsuario',
                contentType: "Application/json",
                data: JSON.stringify(Obj),
                success: function (data) {
                    if (data.resultado == 1) {
...
function getUsuario(IdUsuario, action) {
    var Obj = {
        IdUsuario: IdUsuario,
    ...
    $.ajax({
        type: 'POST',
        url: api + 'Seguridad/GetUsuarioById',
        contentType: "Application/json",
        data: JSON.stringify(Obj),
        success: function (data) {
            if (data.resultado == 1) {
                if (action) {
                    ...
                    $("#tituloModal").text("Datos del Usuario");
...
function deactivateUsuario(IdUsuario) {
    Swal.fire({
        title: 'Validacion',
...
function activateUsuario(IdUsuario) {
    Swal.fire({
        title: 'Validacion',
